...
// ALLL THE MONARCHS!!!!!
  ...
  knex('monarchs').insert({id: 40, name: 'Edward V', epitaph: '(one of the Princes in the Tower)', house: 'York', image_url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/King_Edward_V_from_NPG.jpg/467px-King_Edward_V_from_NPG.jpg', rex_factor_url: 'http://rexfactor.podbean.com/e/33-edward-v-princes-in-the-tower/', born: '2 November 1470', died: D('1483'), ruled_from: D('9 April 1483'), ruled_to: D('25 June 1483')}),
  ...
  // // House of Windsor
  knex('monarchs').insert({id: 64, name: 'George V', epitaph: '', house: '', image_url: 'https://thefirstworldwarin261weeks.files.wordpress.com/2013/09/george-v.jpg', rex_factor_url: 'http://rexfactor.podbean.com/e/60-george-v/', born: D('3 June 1865'), died: D('20 January 1936'), ruled_from: '', ruled_to: D('20 January 1936')}),
  ...
  knex('monarchs').insert({id: 67, name: 'Elizabeth II', epitaph: '', house: '', image_url: 'http://a5.files.biography.com/image/upload/c_fit,cs_srgb,dpr_1.0,q_80,w_620/MTMyODkwNzA1NzgwNjAwODAy.jpg', rex_factor_url: 'http://rexfactor.podbean.com/e/65-elizabeth-ii-1926-53-part-13/', born: D('21 April 1926'), died: '', ruled_from: D('6 February 1952'), ruled_to: ''})
  );
};
